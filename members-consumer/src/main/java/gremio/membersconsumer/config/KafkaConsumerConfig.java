package gremio.membersconsumer.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Member>> factory(
            ConsumerFactory<String, Member> consumerFactory
    ) {
